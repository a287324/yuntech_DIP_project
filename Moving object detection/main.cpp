...
int main(int argc, char *argv[])
{
	...
	open_bmp("picture1.bmp", R, R, R, width, height);
	Closing(R, width, height, B, Structuring_size);
	Opening(R, width, height, B, Structuring_size);
//	Erosion(R, width, height, B, Structuring_size);
    ...
    for(i = 0; i < 2; i++)
    	Erosion(R, width, height, B, Structuring_size);
	*/
	save_bmp("picture1_1.bmp", R, R, R, width, height);
	printf("Job Finished!\n");
